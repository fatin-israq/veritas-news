    ...
    <div className="min-h-screen bg-[#F8F8F6] text-[#0D0D0F] font-sans antialiased flex flex-col justify-between">
      ...
      <main className="max-w-[1280px] mx-auto px-4 md:px-8 py-10 md:py-16 w-full flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-xs space-y-4">
            <h2 className="text-xl font-bold text-[#0D0D0F]">Brand Assets & Logos</h2>
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#0D0D0F] text-white text-xs font-bold rounded-xl hover:bg-black transition-colors"
              >
          ...
          <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-xs space-y-4">
            <h2 className="text-xl font-bold text-[#0D0D0F]">Press Contacts</h2>
            <p className="text-xs text-[#6E7280] leading-relaxed">
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#F4F4F6] text-[#0D0D0F] border border-[#E5E7EB] text-xs font-bold rounded-xl hover:bg-[#E5E7EB] transition-colors"
              >
