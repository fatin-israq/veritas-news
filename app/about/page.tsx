      ...
      <main className="max-w-[1280px] mx-auto px-4 md:px-8 py-10 md:py-16 w-full flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-2xl border border-[#E5E7EB] shadow-xs space-y-3">
            ...
            <h3 className="text-lg font-bold text-[#0D0D0F]">Multi-Perspective Analysis</h3>
          ...
          <div className="bg-white p-6 rounded-2xl border border-[#E5E7EB] shadow-xs space-y-3">
            ...
            <h3 className="text-lg font-bold text-[#0D0D0F]">AI SDK & Gemini Engine</h3>
            <p className="text-xs text-[#6E7280] leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-[#E5E7EB] shadow-xs space-y-3">
            ...
            <h3 className="text-lg font-bold text-[#0D0D0F]">Blindspot Detection</h3>
            <p className="text-xs text-[#6E7280] leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-[#E5E7EB] shadow-xs space-y-3">
            ...
            <h3 className="text-lg font-bold text-[#0D0D0F]">Source Integrity</h3>
            <p className="text-xs text-[#6E7280] leading-relaxed">
        ...
        <div className="bg-gradient-to-br from-[#0D0D0F] to-[#1A1A1E] text-white p-8 md:p-12 rounded-3xl shadow-md border border-[#27272A] flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
